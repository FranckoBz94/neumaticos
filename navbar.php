<nav class="navbar navbar-expand-xl navbar-dark px-4 px-lg-5 py-3 py-lg-3 py-xl-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav mx-auto py-0 pe-4 my-3">
            ...
            <a href="registro-neumatico.php" class="nav-item nav-link">Registra tu Neumático</a>
            ...
            <a href="reclamos.php" class="nav-item nav-link">Reclamos</a>
